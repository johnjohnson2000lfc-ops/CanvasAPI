...
It uses Playwright to launch a browser with your existing Chrome profile, which should
...
# --- CONFIGURATION ---
# IMPORTANT: Replace this with the URL of your Canvas course homepage.
# Example: "https://your-university.instructure.com/courses/12345"
COURSE_URL = "https://liverpool.instructure.com/courses/83671"

# --- SCRIPT SETTINGS ---
DOWNLOAD_DIR = Path("canvas_downloads")
# Add any other file extensions you want to download.
...
def main():
    ...
    with sync_playwright() as p:
        try:
            ...
            print("\nTroubleshooting:")
            print(f"1. Make sure Chrome is installed and the path '{user_data_dir}' is correct.")
            print("2. Close all other running instances of Chrome.")
            return
        ...
        try:
            ...
            if not urls:
                ...
                print("This could be because:\n- The course has no files in the Modules section.\n- The modules are collapsed and couldn't be expanded.\n- The script needs adjustment for your course's structure.")
                return
